...
public class DetailMenu extends AppCompatActivity {
    private Button tomboltambah, tombolkurang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tomboltambah = findViewById(R.id.tambah);
        tombolkurang = findViewById(R.id.kurang);
        progress = findViewById(R.id.galon);

        lblJudul = findViewById(R.id.judul);
        lblDesc = findViewById(R.id.deskripsi);
        lblImg = findViewById(R.id.logo);
